...
export default function EditProductScreen ({ navigation, route }) {
  ...
  const [initialProductValues, setInitialProductValues] = useState({ name: null, description: null, price: null, order: null, productCategoryId: null, availability: null, image: null,visibleUntil:null,fats:null,proteins:null,carbohydrates:null})
