      ...
      >
        ...
        <TextSemiBold>Nutritional composition:</TextSemiBold>
          <View style = {styles.nutritionalInfoContainer}>
            <TextSemiBold>Fats: <TextRegular>{item.fats.toFixed(2)}</TextRegular></TextSemiBold>
            <TextSemiBold>Proteins: <TextRegular>{item.proteins.toFixed(2)}</TextRegular></TextSemiBold>
            <TextSemiBold>Carbohydrates: <TextRegular>{item.carbohydrates.toFixed(2)}</TextRegular></TextSemiBold>
            <TextSemiBold>Calories: <TextRegular>{item.calories.toFixed(2)}</TextRegular></TextSemiBold>
            </View>
        </View>
        ...
        {item.visibleUntil && isAboutToBeInvisible(item.visibleUntil) &&
          <TextRegular textStyle= {styles.visible}>It is about to disapear!</TextRegular>
        }
